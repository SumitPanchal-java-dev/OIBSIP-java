...
{  
    ...
    {  
        ...
        {  
            ...
            jb[0].setText("32 and 64");jb[1].setText("32 and 32");jb[2].setText("32 and 108");jb[3].setText("64 and 64");   
        }  
        if(current==1)  
        {  
        ...
        if(current==10)  
        {  
            l.setText("Que9: Object instance of ...... . ");  
            jb[0].setText("Class");jb[1].setText("int");jb[2].setText("none");jb[3].setText("Console");  
        }  
        l.setBounds(30,40,450,20);  
